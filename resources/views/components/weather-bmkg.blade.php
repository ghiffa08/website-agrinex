<div class="bg-neuBg rounded-[2.5rem] p-6 md:p-8 shadow-[8px_8px_16px_#a3b1c6,-8px_-8px_16px_#ffffff] flex flex-col items-center justify-center text-center h-full">
    ...
    <div class="mb-8">
        <div class="flex items-start justify-center">
            <span class="text-6xl font-extrabold text-darkText tracking-tighter">26</span>
            <span class="text-2xl font-bold text-darkText mt-1">°C</span>
        </div>
        <div class="text-brand font-bold text-lg mt-2 uppercase tracking-widest">Cerah</div>
    </div>
    ...
    <div class="grid grid-cols-2 gap-4 w-full mt-auto">
        ...
        <div class="bg-neuBg rounded-2xl p-4 shadow-[inset_6px_6px_10px_#a3b1c6,inset_-6px_-6px_10px_#ffffff] flex flex-col items-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-lightText mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z" /></svg>
            <span class="text-[10px] font-bold text-lightText uppercase mb-1">Curah Hujan</span>
            <div class="flex items-baseline gap-1">
                <span class="text-xl font-extrabold text-darkText">0</span>
        ...
        <!-- Kecepatan Angin -->
        <div class="bg-neuBg rounded-2xl p-4 shadow-[inset_6px_6px_10px_#a3b1c6,inset_-6px_-6px_10px_#ffffff] flex flex-col items-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-lightText mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M14 5l7 7m0 0l-7 7m7-7H3" /></svg>
            <span class="text-[10px] font-bold text-lightText uppercase mb-1">Angin</span>
            <div class="flex items-baseline gap-1">
                <span class="text-xl font-extrabold text-darkText">12</span>
