...
<section class="grid lg:grid-cols-2 gap-8">
    ...
    <div x-data="satelliteMap()" x-init="init()" class="flex flex-col bg-neuBg shadow-[8px_8px_16px_#a3b1c6,-8px_-8px_16px_#ffffff] rounded-3xl p-6 md:p-8 group relative overflow-hidden">
        <div class="flex items-center justify-between mb-4">
            <h2 class="text-xl font-bold tracking-tight text-darkText">Citra Satelit Lahan</h2>
            <div class="flex gap-2">
                <button @click="switchProvider('esri')" 
                    :class="provider === 'esri' ? 'shadow-[inset_2px_2px_4px_#a3b1c6,inset_-2px_-2px_4px_#ffffff]' : 'shadow-[2px_2px_4px_#a3b1c6,-2px_-2px_4px_#ffffff]'"
                    class="text-[10px] font-bold px-3 py-1 rounded-xl bg-neuBg text-brand transition-all">
                    Esri
                </button>
                <button @click="switchProvider('google')" 
                    :class="provider === 'google' ? 'shadow-[inset_2px_2px_4px_#a3b1c6,inset_-2px_-2px_4px_#ffffff]' : 'shadow-[2px_2px_4px_#a3b1c6,-2px_-2px_4px_#ffffff]'"
                    class="text-[10px] font-bold px-3 py-1 rounded-xl bg-neuBg text-brand transition-all">
                    Google
                </button>
            </div>
